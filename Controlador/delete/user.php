...
<body>
    <?php
     $delete_num = $_GET['id'];
     $sql_delete =  "SELECT * FROM usuario WHERE id_usuario = '$delete_num'";
    ...
    if(!$query_delete){  
        ...
        position: 'center',
        icon: 'error',
        title: 'El Usuario No Puso Ser Eliminado',
    ...
    $sql_delet = "UPDATE usuario SET estado='I' WHERE  id_usuario = '  $delete_num  ' ";
