  ...
  function sendEmail_verify($username,$email,$token)
  {
    $mail = new PHPMailer(true);
            try{
                ...
                <a href='http://localhost/proyecto-final/vista/chef/verificar-email.php?token=$token'>click para verificar</a>";
                $mail->send();
            }catch(Exception $e){
...
//   }
     if(isset($_POST['submit']))
     {
      ...
      }else
      {
        ...
        $query = "INSERT INTO usuario (email,usuario,codigo,password,id_privilegio) VALUES ('$email','$usuario','$token','$password',2)";
