...
<header>
            ...
            <nav class="nav">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="cakes.php" class="nav-link ">Ordenes</a>
                        </li>
                        <li class="nav-item">
                            <a href="orders.php" class="nav-link active">Ventas</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="table-product">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="./edit/sales.php?id_tan=<?php echo $row['id_tan'] ?>&fecha=<?php echo $row['fec_tan'] ?>&id_torta=<?php echo $row['id_torta'] ?>&cant_ven=<?php echo $row['can_pie'] ?>" role="button">
                        ...
                        <td class="delete"><a name="id" id="" class="bdelete"  href="../../controlador/delete/sales.php?id=<?php echo $row['id_tan'] ?>" role="button">
        ...
        <br>
        <a name="" id="" class="Addlist" style="float:right" href="./add/sales.php" role="button">Agregar Venta</a>
        <a href="../pdf/sales.php" class="btn btn-primary" id="esp"><b>PDF</b> </a>
    </div>
    <?php
    mysqli_close($conn);
    ?>
