...
<header>
    ...
    <div class="table-product">
        ...
        <div class="addproduct">
            <form method="POST" action="../../../Controlador/admin/add/unit.php">
                <!-- <div class="form-group">
                    <label for="exampleInputEmail1">Fecha</label>
                    <br>
                    <input type="text" class="form-control" name="fecha" onblur='validacion2(value,this)'>
                </div> -->
       
                <div class="form-group">
                    <label for="exampleInputEmail1">Unidad</label>
                    <br>
                    <input type="text" class="form-control texto" name="unit" >
                </div>
