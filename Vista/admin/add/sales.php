...
<header>
    ...
    <div class="table-product">
        ...
        <form method="POST" action="../../../controlador/admin/add/sales.php">
                ...
                <button class="boton-validador modify" style="float:right">Agregar venta</button>
                <button type="submit" class="original" style="float:right" hidden>Agregar venta</button>
