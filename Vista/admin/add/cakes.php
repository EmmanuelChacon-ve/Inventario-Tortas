...
<header>
    ...
    <div class="table-product">
        ...
        <div class="addproduct">
            <form method="POST" action="../../../controlador/admin/add/cakes.php">
    
                <div class="form-group">
                    <label for="exampleInputEmail1">Nombre del producto</label>
                    <br>
                    <input type="text" class="form-control  textoEspacio" name="name"  >
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Precio</label>
                    <br>
                    <input type="text" class="form-control numeros" name="precio"  >
                </div>
                <br>
                <div class="form-button">
               
                    <button type="submit" class="modify" style="float:right">Agregar Torta</button>
