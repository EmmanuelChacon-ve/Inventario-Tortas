...
$sql_fetch_todos = "SELECT * FROM unidades where estado='A' ORDER BY id_uni ASC";
...
<header>
    ...
    <div class="table-product">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="./edit/unit.php?id=<?php echo $row['id_uni'] ?>&unidad=<?php echo $row['des_uni'] ?>" role="button">
                        <img src="../img/editor-de-texto.png" class="edit">
                            </a></td>
                        <td class="delete"><a name="unidad" id="" class="bdelete" href="../../Controlador/delete/unit.php?id=<?php echo $row['id_uni'] ?>" role="button">
        ...
        <br>
        <div>
        <a name="" id="" class="Addlist" style="float:right" href="./add/unit.php" role="button">Agregar Unidad</a>
        <a href="../pdf/unit.php" class="btn btn-primary" id="esp"><b>PDF</b> </a>
        </div>
    </div>
    <?php
    mysqli_close($conn);
