...
<header>
    ...
    <div class="table-product">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="./edit/supplies.php?id=<?php echo $row['id_ins'] ?>&insumo=<?php echo $row['des_ins'] ?>&unidad=<?php echo $row['id_uni'] ?>&existenciamin=<?php echo $row['exi_min'] ?>&existenciamax=<?php echo $row['exi_max'] ?>&cantidad=<?php echo $row['can_disp'] ?>" role="button">
                        <img src="../img/editor-de-texto.png" class="edit">
                            </a></td>
                        <td class="delete"><a name="unidad" id="" class="bdelete" href="../../controlador/delete/supplies.php?id=<?php echo $row['id_ins'] ?>" role="button">
        ...
        <br>
        <a name="" id="" class="Addlist" style="float:right" href="./add/supplies.php" role="button">Agregar Insumo</a>
        <a href="../pdf/supplies.php" class="btn btn-primary" id="esp"><b>PDF</b> </a>
