...
<header>
    ...
    <div class="fixproduct">
        <form method="POST" action="../../../Controlador/admin/edit/cakes.php">
            <div class="form-group">
                <label for="exampleInputEmail1">Nombre del Producto</label>
                <br>
                <input type="text" class="form-control textoEspacio" name="name" value="<?php echo $_GET['message']; ?>" >
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Nombre del Producto</label>
                <br>
                <input type="number" class="form-control" name="precio" step="0.5" value="<?php echo $_GET['precio']; ?>" >
            ...
            <button class="boton-validador modify" style="float:right">editar torta</button>
            <button type="submit" class="original" style="float:right" hidden>editar torta</button>
                <a href="../cakes.php" class="btn btn-primary" id="es"><b>volver</b> </a>
            </div>
