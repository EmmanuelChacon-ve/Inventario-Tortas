...
<header>
    ...
    <div class="fixproduct">
        <form method="POST" action="../../../Controlador/admin/edit/unit.php">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Nombre del Producto</label>
                <br>
                <input type="text" class="form-control texto" name="unit" value="<?php echo $_GET['unidad']; ?>" >
            ...
            <button class="boton-validador modify" style="float:right">Agregar Unidad</button>
            <button type="submit" class="original" style="float:right" hidden>Agregar Unidad</button>
                <a href="../unit.php" class="btn btn-primary" id="es"><b>volver</b> </a>
            </div>
        </form>
    </div>
    <?php
