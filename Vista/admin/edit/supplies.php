...
<header>
            ...
            <nav class="nav">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="../unit.php" class="nav-link active">Unidades</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="fixproduct">
        <form method="POST" action="../../../Controlador/admin/edit/supplies.php">
            <div class="form-group">
                <label for="exampleInputEmail1">Insumo</label>
                <br>
                <input type="text" class="form-control textoEspacio" name="insumo" value="<?php echo $_GET['insumo']; ?>" >
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" class="form-control numeros" name="max" value="<?php echo $_GET['existenciamin']; ?>" >
                
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Existencia Minima</label>
                <br>
                <input type="text" class="form-control numeros" name="min" value="<?php echo $_GET['existenciamax']; ?>" >
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" class="form-control numeros" name="cantidad" value="<?php echo $_GET['cantidad']; ?>" >
            ...
            <button class="boton-validador modify" style="float:right">Editar insumo</button>
            <button type="submit" class="original" style="float:right" hidden>Editar Insumo</button>
