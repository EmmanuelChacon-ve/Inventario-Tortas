...
<header>
            ...
            <nav class="nav">
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="receta.html" class="nav-link ">Recetas</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="table-product">
            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="./edit/orders.php?id=<?php echo $row['id_orden'] ?>&nombre=<?php echo $row['nombre_comprador'] ?>&cedula=<?php echo $row['cedula_comprador']?>&numero=<?php echo $row['numero_comprador']?>&fecha=<?php echo $row['fecha_orden']?>" role="button">
                        ...
                        <td class="delete"><a name="id" id="" class="bdelete"  href="../../Controlador/delete/orders.php?id=<?php echo $row['id_orden'] ?>" role="button">
        ...
        <br>
        <a name="" id="" class="Addlist" style="float:right" href="add/orders.php" role="button">Agregar Orden</a>
        <a href="../pdf/orders.php" class="btn btn-primary" id="esp"><b>PDF</b> </a>
    </div>
    <?php
    mysqli_close($conn);
    ?>
