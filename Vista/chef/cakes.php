            ...
            <?php
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td class="modify"><a name="edit" id="" class="bfix" href="./edit/cakes.php?id=<?php echo $row['id_torta'] ?>&torta=<?php echo $row['des_torta'] ?>&precio=<?php echo $row['precio']?>" role="button">
                        ...
                        <td class="delete"><a name="id" id="" class="bdelete"  href="../../controlador/delete/cakechef.php?id=<?php echo $row['id_torta'] ?>" role="button">
