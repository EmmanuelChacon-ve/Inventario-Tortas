...
<header>
    ...
    <form method="POST" action="../../../Controlador/chef/edit/cakes.php">
            <div class="form-group">
                <label for="exampleInputEmail1">Nombre del Producto</label>
                <br>
                <input type="text" class="form-control texto" name="name" value="<?php echo $_GET['torta']; ?>" >
            ...
            <div class="form-group">
                ...
                <br>
                <input type="number" class="form-control numeros" name="precio" step="0.5" value="<?php echo $_GET['precio']; ?>" >
