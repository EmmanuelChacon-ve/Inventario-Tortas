...
function Header()
{
    ...
    $this->SetX(8);
    $this->Cell(38,10,'Id Receta',1,0,'C',0);
    $this->Cell(38,10,'Id Torta',1,0,'C',0);
    $this->Cell(38,10,'Id Insumo',1,0,'C',0);
    $this->Cell(44,10,'Cantidad Insumo',1,0,'C',0);
    $this->Cell(38,10,'Id Unidad',1,1,'C',0);
...
$sql_fetch_todos = "SELECT id_tortas,id_torta,id_ins,can_ins,id_uni FROM receta";
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->SetX(8);
    $pdf->Cell(38,10,$row['id_tortas'],1,0,'C',0);
    $pdf->Cell(38,10,$row['id_torta'],1,0,'C',0);
    $pdf->Cell(38,10,$row['id_ins'],1,0,'C',0);
    $pdf->Cell(44,10,$row['can_ins'],1,0,'C',0);
    $pdf->Cell(38,10,$row['id_uni'],1,1,'C',0);
