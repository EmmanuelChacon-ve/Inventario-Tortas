...
function Header()
{
    ...
    // Título
    $this->Cell(70,10,'Tabla de Unidades ',0,0,'C');
    // Salto de línea
   
    $this->Ln(30);
    $this->SetFont('Arial','B',10);
    $this->SetX(8);
    $this->Cell(90,10,'Id Unidad',1,0,'C',0);
  
    $this->Cell(105,10,'Nombre Unidad',1,1,'C',0);
...
$sql_fetch_todos = "SELECT id_uni,des_uni FROM unidades";
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->Cell(90,10,$row['id_uni'],1,0,'C',0);
    $pdf->Cell(105,10,utf8_decode($row['des_uni']),1,1,'C',0);
